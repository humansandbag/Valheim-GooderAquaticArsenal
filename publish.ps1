...
if($Target.Equals("Release")) {
    ...
    New-Item -Type Directory -Path "$PackagePath\MainStreetGaming-GooderEquipInWater" -Force
    Copy-Item -Path "$TargetPath\$TargetAssembly" -Destination "$PackagePath\MainStreetGaming-GooderEquipInWater\$TargetAssembly" -Force
